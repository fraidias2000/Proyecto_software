...
public class Videojuego {
    ...
    /*
     * Se les da valor a todos los atributos de videojuego. 
     * El atributo código que es el que identifica al videojuego, 
     * se incrementa positivamente.
     */
    ...
    public String listarBreveInformacion(){
        return codigo + SEPARACION + nombre + SEPARACION + precio +
               SEPARACION + tipoGenero + SEPARACION + tipoPlataforma + 
    ...
    public String listarExtensaInformacion(){
        return codigo + SEPARACION + nombre + SEPARACION + precio + 
                SEPARACION + tipoGenero + SEPARACION + tipoPlataforma + 
                SEPARACION + puntuacion + SEPARACION + stock +SEPARACION + 
                diasAlquiler + SEPARACION + foto + SEPARACION + 
                disponible;
    }  
    
    /*
     * La puntuacion del videojuego se calcula mediante la media
     * aritmética juntando todas las puntuaciones recibidas.
     */
    public void anyadirPuntuacion (int puntuacion){
        contadorPuntuacion++;
        this.puntuacion = (this.puntuacion + puntuacion) / contadorPuntuacion; 
    }
}
