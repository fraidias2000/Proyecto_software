...
public class Agencia {
    ...
    public boolean devolverVideojuego(String DNI, int codigoVideojuego){
        ...
        if((usuarioAux!= null) && (videojuegoAux != null)){
            if(videojuegosRegistrados.get(codigoVideojuego).devolverVideojuego(codigoVideojuego)){ //Se tiene que comprobar que se ha podido eliminar de la BD               
                usuarioAux.eliminarVideojuegoDelPedido(videojuegoAux.getCodigo());    
                return true;
            }
            return false;
        }else{
     ...
     */
    public void registrarUsuario(String nombre,String DNI, String apellido1, 
                   String apellido2, String contrasenia, 
                   String correoElectronico, String direccion,
                   int tarjeta){
        Usuario usuario = new Usuario(nombre,DNI, apellido1, apellido2, 
