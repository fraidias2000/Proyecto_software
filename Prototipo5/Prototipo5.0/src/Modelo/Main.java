    ...
    public static void main(String[] args) {
       ...
       //-----------Usuario 1-------------
        ...
        try {
            ...
            //Prueba1: Alquilamos un videojuego y ampliamos su fecha de devolucion
            agencia.registrarUsuario(nombre, DNI, apellidosprueba1, contrasenia, correoElectronico, direccion, tarjeta);  
            agencia.alquilarVideojuego(DNI, 3);
            agencia.ampliarFechaDevolucion(DNI, 3,fechaDevolucion2);
