...
public class Agencia {
     ...
     * almacenado en la BD
     */
    public Agencia(String ficheroVideojuegos, String direccion, long telefono) 
        throws IOException{
    ...
    public void darDeAltaVideojuego(int codigo, String nombreVideojuego, 
        ...
        Videojuego videojuego = new Videojuego(codigo, nombreVideojuego, 
                                               precio, this.tipoGenero, 
                                               this.tipoPlataforma, puntuacion, 
                                               stock, diasAlquilerPorDefecto, 
                                               imagenCaratula);
    ...
    public String mostrarInformacionBreveVideojuego(int codigoVideojuego){
        return misVideojuegos.get(codigoVideojuego).listarBreveInformacion();
    }
    ...
    public String mostrarInformacionExtensaVideojuego(int codigoVideojuego){
        return misVideojuegos.get(codigoVideojuego).listarExtensaInformacion();
    }
